          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg font-semibold transition-all flex items-center gap-2 shadow-sm ${
              filterStation === station.id
                ...
                : "bg-linear-to-r from-orange-100 to-amber-200 text-gray-800 hover:from-orange-300 hover:to-amber-300 border border-orange-300"
            }`}
          >
            {station.icon}
      ...
      <div className="flex gap-2 ml-auto">
        <button
          ...
          className={`px-4 py-2 rounded-lg font-semibold transition-all shadow-sm ${
            filterStatus === "all"
              ? "bg-linear-to-r from-slate-500 to-slate-600 text-white shadow-lg scale-105"
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-semibold transition-all shadow-sm ${
                filterStatus === key
                  ...
                  : `bg-linear-to-r from-white to-gray-50 ${config.textColor} hover:from-gray-50 hover:to-gray-100 border-2 border-current opacity-80 hover:opacity-100`
              }`}
            >
              {config.label}
            </button>
